...
\section{Interception Formulas}



\subsection{Determine an optimum speed for interception}
...
\subsection{Intercept lead angle}
%%beta = arccos{sqrt[1-(vt*sin(alpha)/v)^2]}

$$interceptAngle = arcCos(\sqrt{1-(vt*sin(alpha)/v)^2})$$
