...
\author{fSocko}
\title{Pacific Campaign and Torpedo Solution Reference (v0.5)}
...
The following is torpedo for American torpedo types as used predominantly in the Pacific theatre. Slow and Fast speeds and ranges removed as appropriate. Torpedo data adapted from \cite{ultTorp}.
