...
\emph{arming\_distance} is set across all torps to 220 meters except the Mk. 27, which has 150 meters.
...
\emph{max\_turn\_angle} is 135\degree for all torps except the Mk. 27, which has 180?

\subsubsection{Magnetic detonation range}
\emph{mag\_detonation\_range} is 2m for all torps except for the Mk. 27, which has 1m

\subsubsection{Circular runner torpedos}
\emph{circle\_runner\_chance} is 0.5\% for all torps except for the Mk. 27, which has 0\%

\subsubsection{Gyro problems}
The chance of having gyro problems is 0.3\% at the introduction time of all torpedoes and drops to 0.2\% in later periods for all torpedoes except for the Mk. 16. The max\_deviation when having gyro problems is always 50\degree. This does not apply to the Mk. 27. 
